    ...
    Column(
        ...
        if (status.isDebuggable) {
            WarningCard(
                ...
                description = "This is a debug build of the app. Debug builds have weaker security protections. Please use the release version for your safety.",
                isBlocking = true,
            )
        }
        ...
        if (status.isTampered) {
            WarningCard(
                ...
                description = "The app binary appears to have been modified. Please re-download the app from a trusted source.",
                isBlocking = true,
            )
        }
        ...
        if (!status.isFromAllowedSource) {
            WarningCard(
                ...
                description = "This app was installed from an unrecognized source. For safety, download only from Google Drive or trusted sources.",
                isBlocking = false,
            )
        }
